...
const Footer = () => {
    return (
        <div className='bg-[#30303af2] text-white'>
            <footer class="footer  p-10 mt-[30px] md:mt-[60px] lg:mt-[90px]">
                <div>
            ...
            <footer class="bg-[#30303af2] footer px-10 py-4  ">
                <div class="items-center grid-flow-col">
                    ...
                    <p>Reducx-ecommerce cart by - Hr Meheraj {":)"} <br/>&copy; copyright all right reserved by {new Date().getFullYear()}</p>
                </div>
